...
import logo from './assets/images/logo_pineapple.png';
...
const App = () => {
  ...
  const [subscriberData, setSubscriberData] = useState<SubscriberDataType[]>([]);

  const subscribeHandler = () => {
    console.log('emailValue', emailValue, 'isChecked', isChecked);
    const newSubscriberData = { email: emailValue, isSubscribed: isChecked };
    setSubscriberData([...subscriberData, newSubscriberData]);
